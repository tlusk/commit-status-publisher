...
public abstract class BaseCommitStatusPublisher implements CommitStatusPublisher {
  ...
  public boolean isDependencyPublishingUnmatchedBranchesEnabled() {
    final String publishPullRequest = StringUtil.emptyIfNull(myParams.get(Constants.PUBLISH_TO_DEPENDENCIES_UNMATCHED_BRANCHES)).trim();
    return Boolean.valueOf(publishPullRequest);
  }
